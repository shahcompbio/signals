...
We can use information from scDNAseq to phase the SNPs in scRNAseq. It's also possible to perform this phasing just based on scRNAseq. We'll first compute haplotype specific copy number in scDNAseq and use this phasing information in the scrnaseq.
