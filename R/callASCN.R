...
alleleHMM <- function(n,
  ...
  ihmm <- HMM::initHMM(States = paste0(minor_cn),
                       Symbols = paste0(1:length(binstates)),
                       transProbs = tProbs, emissionProbs = t(eProbs))
  res <- HMM::viterbi(ihmm, paste0(1:length(binstates)))
